            ...
            <div className="rgt-list">
              ...
              <div className="row">
                <div className="col-md-7">
                  <ul>
                    <li>
                      Welcome <span>10,000 new wolves</span> to the pack!
                    </li>
                    <li>
                    ...
                    <li>
                      <span> Rarity tools</span> and <span> rarity sniper</span>{" "}
                    ...
                    <li>
                      <span>Alpha Wolf Sessions</span> begin with a special
                      guest kickoff session!
                    </li>
                    <li>
                      <span> Our second drop</span> will be put into motion and
                ...
                <div className="rgt-listtwo">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      planned for launching at the end of year or into early
                      2023 to add more funds to the vault and expand our reach.
                      Our initial WSW holders will <span>ALWAYS</span>receive
